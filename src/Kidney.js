...
function Kidney() {
    ...
    const displayVideo = async (val) => {
        try {
            const organsRef = query(collection(db, "organs"), where("type", "==", 'kidney'));
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', marginTop: '5rem' }}>
                ...
                <div onClick={() => displayVideo(3)} style={{ background: 'red', cursor: 'pointer', textDecoration: 'none', color: 'white', padding: '.5rem', width: '15rem', fontSize: '1.4rem', textAlign: 'center', marginTop: '1.5rem'  }}>
